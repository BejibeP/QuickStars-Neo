...
@Component({
  selector: 'app-copie-mail-joueurs-dialog',
  templateUrl: './copie-mail-joueurs-dialog.component.html',
  styleUrls: ['./copie-mail-joueurs-dialog.component.scss']
})
export class CopieMailJoueursDialogComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    this.copie = await this._mailService.getListMailsJoueurs();
 }
