...
## Additions included
- Lazy-loaded `profile` feature module (src/app/features/profile)
- .NET example controller and OTK service (docs/*.cs, docs/*.md)
- PrimeNG & Angular Material scaffolding + Storybook stories for Material and PrimeNG buttons

Run `npm install` to get Material and PrimeNG packages. Material requires additional setup (theme import) in styles.css.
